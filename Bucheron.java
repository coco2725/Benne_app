...
public class Bucheron extends Thread
{
	...
	{
		System.out.println(this.getName() + " arriv� vers la benne");
		try {
			//cont�le si la benne � remplir est arriv�e
			if(_listDeBennes.get(_numBenneARemplir).getEtat() == EnumEtatBenne.DESAMARRER_EN_FORET)
			{
				System.out.println(this.getName() + ", " + _benneAAttendre + " est arriv�e");
